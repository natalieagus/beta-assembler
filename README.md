...
`LD` and `ST` are each encoded **twice** (two consecutive identical words). This satisfies the Alchitry AU BRAM timing requirement. The FPGA RAM takes 2 clock cycles to write and be readable again.
